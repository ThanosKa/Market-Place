export const categories = [
  { id: "woman-sharp", label: "womens-fashion", value: "womenFashion" },
  { id: "airplane-outline", label: "travel", value: "travel" },
  { id: "phone-portrait-outline", label: "mobile", value: "mobile" },
  {
    id: "nutrition-outline",
    label: "health-and-beauty",
    value: "healthANDbeauty",
  },
  { id: "diamond-outline", label: "luxury", value: "luxury" },
  { id: "settings-outline", label: "home-services", value: "homeServices" },
